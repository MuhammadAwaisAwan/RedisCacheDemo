...
namespace RedisCacheDemo.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        public ProductController(DbContextClass dbContext, IMapper mapper, ICacheService cacheService)
        {
        ...
        public IEnumerable<Product> Get()
        {
            ...
            cacheData = _dbContext.Products.Include(x => x.productImages).ToList();
        ...
        public Product Get(int id)
        {
            ...
            filteredData = _dbContext.Products.Include(x => x.productImages).Where(x => x.ProductId == id).FirstOrDefault();
            return filteredData;
        }
